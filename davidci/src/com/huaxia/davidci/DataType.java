...
public class DataType {
	...
	public static void main(String[] args) {
		...
		// Developer defined data type, every user defined class is user defined data
		// type
		...
		System.out.println(h);
		Print p = new Print();
		System.out.println(p); // com.huaxia.davidci.Print@1246ca6 this is result is from default toString()
								// method.
	}
